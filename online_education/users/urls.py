...
urlpatterns = [
    ...
    path(
        "user/<int:pk>/delete/", views.UserDeleteAPIView.as_view(), name="user_delete"
    ),
    path(
        "user/<int:pk>/update/", views.UserUpdateAPIView.as_view(), name="user_update"
    ),
    path("user/token/", TokenObtainPairView.as_view(), name="token_obtain_pair"),
    path("user/token/refresh/", TokenRefreshView.as_view(), name="token_refresh"),
    # Payments
    path(
        "payments/create/", views.PaymentsCreateAPIView.as_view(), name="payment_create"
    ),
